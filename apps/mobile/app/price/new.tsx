...
export default function NewPriceScreen() {
  ...
  return <Screen>
    ...
    <Card tone="sun"><View style={styles.summary}><Ionicons name="eye-outline" size={24} color={colors.primaryDark} /><View style={{ flex: 1 }}><Text style={styles.summaryTitle}>Avant de publier</Text><Text style={styles.summaryText}>Vérifiez le montant et le magasin. Aucune photo ni position GPS exacte n’est enregistrée.</Text></View></View></Card>
    <Button label="Publier ce prix" icon="paper-plane" loading={mutation.isPending} onPress={() => void handleSubmit(onSubmit)()} />
  </Screen>;
}

const styles = StyleSheet.create({ product: { flexDirection: 'row', alignItems: 'center', gap: 12 }, productIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center' }, brand: { color: colors.primaryDark, fontSize: 10, fontWeight: '900', textTransform: 'uppercase' }, productName: { color: colors.ink, fontSize: 14, fontWeight: '900', marginTop: 2 }, meta: { color: colors.muted, fontSize: 11, marginTop: 3 }, store: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 15, borderRadius: radius.lg, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line }, storeIcon: { width: 46, height: 46, borderRadius: 15, backgroundColor: '#E7F8EF', alignItems: 'center', justifyContent: 'center' }, storeName: { color: colors.ink, fontWeight: '900' }, typeRow: { flexDirection: 'row', gap: 9 }, type: { flex: 1, minHeight: 76, padding: 14, borderRadius: radius.lg, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line, gap: 7 }, typeActive: { backgroundColor: colors.ink, borderColor: colors.ink }, typeText: { color: colors.ink, fontWeight: '800' }, typeTextActive: { color: colors.white }, toggle: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, borderRadius: radius.lg, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line }, toggleTitle: { color: colors.ink, fontWeight: '800', fontSize: 14 }, availability: { flexDirection: 'row', gap: 8 }, availabilityItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 5, padding: 10, borderRadius: radius.md, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line }, availabilityActive: { borderColor: colors.primary, backgroundColor: '#FFF0ED' }, availabilityText: { fontSize: 10, fontWeight: '800', color: colors.ink, textAlign: 'center' }, textarea: { height: 100, paddingTop: 14, textAlignVertical: 'top' }, summary: { flexDirection: 'row', alignItems: 'center', gap: 12 }, summaryTitle: { color: colors.ink, fontWeight: '900' }, summaryText: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 4 },
});
