...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontSize: 12, fontWeight: '900', color: colors.primary, textTransform: 'uppercase', letterSpacing: 1.4, marginBottom: 5 },
  ...
  card: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: 18, borderWidth: 1, borderColor: colors.line, ...shadow }, cardMint: { backgroundColor: colors.blueSoft, borderColor: '#CFDCFF' }, cardSun: { backgroundColor: colors.yellowSoft, borderColor: '#F1F17C' },
  ...
  pill: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 5, borderRadius: radius.pill, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: colors.blueSoft }, pill_neutral: { backgroundColor: colors.blueSoft }, pill_green: { backgroundColor: colors.mint }, pill_coral: { backgroundColor: colors.redSoft }, pill_yellow: { backgroundColor: colors.sunshine }, pillText: { fontSize: 11, fontWeight: '900', color: colors.ink },
